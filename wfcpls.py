...
# # # Example usage:
# builder = EnhancedWFC3DBuilder('adjacencies.json', strategy='collapsed_neighbors')

# # builder = WFC3DBuilder('adjacencies.json')
# editor = Editor(buffering=True)

# start_pos = ivec3(320, -60, 369)
# result = builder.generate_grid(editor, 7, 7, 7, start_pos) 
# builder.build_in_minecraft(editor, result, start_pos)

# if result:
#     print("Saving WFC grid...")
#     with open('wfc_grid.pkl', 'wb') as f:
